  ...
  <section>
    ...
    <div class="sidebar">
      ...
      <div class="" id="sidebar-here">
        ...
        <a href="web_app_development_table.php" class="active">Web & App Development</a>
      </div>
    </div>
      ...
      <div id="mySidenav" class="sidenav">
        ...
        <div class="pt-0" id="sidebar-here">
          <div class="pt-3" id="sidebar-here">
            ...
            <a href="election_management.php" class="list ">Election Management</a>
            <a href="election_material.php">Election Material</a>
            <a href="web_app_develpoment_table.php" class="active">Web & App Development</a>
          </div>
        </div>
          ...
          <div class="col-md-10">
            <div class="card my-5 shadow">
              ...
              <div class="card-body text-center">
                <a href="web_development.php" class="btn btn-dark m-1">Web Development</a>
                <a href="app_development.php" class="btn btn-dark m-1">App Development</a>

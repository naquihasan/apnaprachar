  ...
  <section>
    ...
    <div class="sidebar">
      ...
      <div class="" id="sidebar-here">
       <a href="graphic_design_table.php" class="list active">Graphic Design</a>
      ...
      <div class="col-md-10">
        <div class="card my-5 shadow">
          <nav class="navbar navbar-light  venue-registration border-bottom">
            <a class="h4 text-dark font-weight-bold pt-2">Graphic Design List </a>
          </nav>

          <div class="card-body text-center">
              <a href="facebook_graphic.php" class="btn btn-dark mx-1">Facebook</a>
              <a href="instagram_graphic.php" class="btn btn-dark mx-1">Instagram</a>
              <a href="youtube_graphic.php" class="btn btn-dark mx-1">Youtube</a>
              <a href="twitter_graphic.php" class="btn btn-dark mx-1">Twitter </a>
              <a href="linkedin_graphic.php" class="btn btn-dark mx-1">Linked Link</a>
